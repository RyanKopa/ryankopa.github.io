...
draft = false
tags = []
title = "Researcher, University of California, Davis"
math = false
summary = """
Davis, California / May 2015 - June 2017 \t
• Leading and designing studies using convolutional neural networks
to detect twinning boundaries on materials' surfaces from scanning
electron microscope (SEM) images, 83% tested accuracy.
"""
+++
