...
draft = false
tags = []
title = "Data Engineer at Accenture"
math = true
summary = """
Menlo Park, California / Sept 2017 – April 2018 \t
• Created an analytics platform for understand and visualize the
reliability of the client’s servers and other hardware. \t
• Built file ingestion process using AWS S3 to collect data, execute
data quality checks, and move data into client’s databases. \t
• Developed data pipelines using Python, SQL, Presto, and Hive. \t
• Worked with PMs to improve vendor data reporting, leading to the
successful onboarding of 10 different data sources.
"""
...
- Write in [Markdown] for easy formatting and code highlighting, with [LaTeX](https://en.wikibooks.org/wiki/LaTeX/Mathematics) for mathematical expressions
